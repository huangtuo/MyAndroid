package com.demo.ht.myandroid.service;
...
import com.demo.ht.myandroid.Receiver.WakeReceiver;
import com.demo.ht.myandroid.utils.ToastUtils;
...
public class GrayService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if(Build.VERSION.SDK_INT < 18){
            ...
            Intent service = new Intent(this, GrayInnerService.class);
...
//            stopForeground(true);
    ...
    public class MyBinder extends Binder{
        public void toWork(){
            ToastUtils.showLongToast(GrayService.this,"绑定服务已启动");
        }
    }
